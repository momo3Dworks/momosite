...
"[project]/node_modules/react-powerglitch/lib/react-powerglitch.es.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
;
var w = Object.defineProperty, G = Object.defineProperties, M = Object.getOwnPropertyDescriptors, g = Object.getOwnPropertySymbols, k = Object.prototype.hasOwnProperty, O = Object.prototype.propertyIsEnumerable, f = (e, t, i)=>t in e ? w(e, t, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: i
    ...
    if (g) for (var i of g(t))O.call(t, i) && f(e, i, t[i]);
    return e;
}, S = (e, t)=>G(e, M(t));
const y = (e = "always")=>({
        playMode: e,
    ...
    for(let r = 0; r < t; ++r){
        ...
        const n = {
            opacity: "1",
            transform: `translate3d(${m(e, r / t) * 30}%,0,0)`,
            clipPath: C({
                minHeight: e.slice.minHeight,
                maxHeight: e.slice.maxHeight,
                minWidth: 1,
                maxWidth: 1
            })
        };
    ...
    return {
        ...
        steps: [
            ...
            {
                transform: `scale(${e.pulse.scale})`,
                opacity: "0"
            }
        ],
        timing: S(u({}, e.timing), {
            delay: (e.glitchTimeSpan ? e.glitchTimeSpan.start : 0) * e.timing.duration,
            easing: "ease-in-out"
        })
    } : null, x = (e)=>{
    if (!e.shake) return {
    ...
    var i, r;
    if (!t.createContainers) return {
        container: e,
        layersContainer: e,
        glitched: e.firstElementChild
    };
    if (!e.dataset.glitched) {
        const a = document.createElement("div"), l = document.createElement("div");
        return getComputedStyle(e).getPropertyValue("display").match(/^inline/) && (l.style.display = "inline-block"), l.appendChild(a), (i = e.parentElement) == null || i.insertBefore(l, e), a.prepend(e), {
            container: l,
            layersContainer: a,
            glitched: e
        };
    ...
    return n.firstElementChild.getAnimations().forEach((a)=>a.cancel()), {
        container: o,
        layersContainer: n,
        glitched: e
    };
    ...
    if (i.optimizeSeo && /google|bing|baidu|yandex|slurp|bot/i.exec(navigator.userAgent)) return {
        containers: [],
        startGlitch: ()=>{
    ...
    let r = [];
    typeof e == "string" ? r = Array.from(document.querySelectorAll(e)) : e instanceof NodeList ? r = Array.from(e) : Array.isArray(e) ? r = e : e instanceof HTMLElement && (r = [
        e
    ]);
    const n = b(i), o = r.filter((a)=>!a.dataset.islayer).map((a)=>j(a, n, i));
    return {
        containers: o.map((a)=>a.container),
        startGlitch: ()=>o.forEach((a)=>a.startGlitch()),
        stopGlitch: ()=>o.forEach((a)=>a.stopGlitch())
    };
}, L = {
    glitch: T,
    generateLayers: b,
...
function W(e) {
    const [t, i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(e), [r, n] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>()=>{}), [o, a] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>()=>{});
    return {
        ref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((c)=>{
            if (!c) return;
...
//# sourceMappingURL=node_modules_a345d895._.js.map